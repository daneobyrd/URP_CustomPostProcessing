...
public sealed class GradientParameter : VolumeParameter<Gradient>
{
    public override Gradient value
    {
        get
        {
            if (m_Value == null)
            {
                m_Value = GradientUtility.DefaultGradient;
            }
    ...
    public override string ToString() { return $"{value.colorKeys} ({overrideState})"; }
}

public static class GradientUtility
{
    static readonly GradientColorKey[] _defaultColorKeys = new[] {new GradientColorKey(Color.blue, 0), new GradientColorKey(Color.red, 1)};

    static readonly GradientAlphaKey[] _defaultAlphaKeys = new[] {new GradientAlphaKey(1, 0), new GradientAlphaKey(1, 1)};

    static readonly int[] _colorKeyPropertyIDs = new[]
    {
        Shader.PropertyToID("_ColorKey0"), Shader.PropertyToID("_ColorKey1"), Shader.PropertyToID("_ColorKey2"), Shader.PropertyToID("_ColorKey3"), Shader.PropertyToID("_ColorKey4"),
        Shader.PropertyToID("_ColorKey5"), Shader.PropertyToID("_ColorKey6"), Shader.PropertyToID("_ColorKey7")
    };
